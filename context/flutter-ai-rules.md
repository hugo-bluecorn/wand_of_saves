...
> Source: flutter/flutter `docs/rules/rules_10k.md`
> Pinned from: ai-context store snapshot `36b35dd79ff` (2026-07-16)
> Upstream: https://raw.githubusercontent.com/flutter/flutter/main/docs/rules/rules_10k.md
> Pinned: 2026-08-05
>
> **Note for wand_of_saves:** carried over from the `near_infinity_flutter` experiment, which
> pinned it. This is the target-side canon for this project too. The MVVM bullet governs the app
> architecture (see `mvvm-architecture-record.md`). The State Management section's native-first
> default is **overridden by a declared deviation** — **Riverpod 3.x with manually declared
> providers, no code generation** — see `planning/decisions.md`, D2. Everything else applies as
> written.
