...
class FindingsBadge extends StatelessWidget {
  ...
  ///
  /// [onPressed] may be `null` on a screen with nowhere to go — the count is
  /// worth showing either way, and an enabled button that does nothing is the
  /// dead control this UI pass exists to remove.
  const FindingsBadge({
