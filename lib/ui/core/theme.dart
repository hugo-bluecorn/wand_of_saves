...
///
/// **Starfleet is the chosen palette — D15.** It was picked by building three
/// alternatives and looking at them, and this is where that decision lands in
/// code: one name, no parameter, so no screen can be drawn in a palette nobody
/// chose.
abstract final class AppTheme {
  /// The light theme.
  static ThemeData get light =>
      WorkbenchTheme.light(WorkbenchPalette.starfleet);

  /// The dark theme.
  static ThemeData get dark => WorkbenchTheme.dark(WorkbenchPalette.starfleet);
}
